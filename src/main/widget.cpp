...
void Widget::setInterfaceStyle()
{
    ...
    ui->starButton->setStyleSheet(StyleHelper::getStartButtonsStyle());
...
{
    QFontDatabase::addApplicationFont(":/resourrses/fonts/Roboto-Medium.ttf");
    int id=QFontDatabase::addApplicationFont(":/resourrses/fonts/Roboto-MediumItalic.ttf");
...
void Widget::on_starButton_clicked()
{
    ...
    if(gameStart){
        ...
        start();
        lockPlayer();
        ui->starButton->setText("Сдаюсь...");
        ui->starButton->setStyleSheet(StyleHelper::getStartButtonGameStyle());
...
void Widget::endGame()
{
    ...
    if(stop){
        if(winner == player){
            ...
            ui->messageLabel->setText("Поражение");
            ui->messageLabel->setStyleSheet(StyleHelper::getLostMessageStyle());
        }
        playerLocked = true;
        ui->starButton->setText("Играть");
